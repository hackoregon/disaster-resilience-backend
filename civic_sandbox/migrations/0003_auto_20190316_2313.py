# Generated by Django 2.0.12 on 2019-03-16 23:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visualization', models.CharField(choices=[('CM', 'ChoroplethMap'), ('SM', 'ScatterPlotMap'), ('PM', 'PathMap'), ('PP', 'PolygonPlotMap'), ('IM', 'IconMap'), ('SG', 'ScreenGridMap')], default='SM', max_length=2)),
            ],
        ),
        migrations.CreateModel(
            name='Packages',
        ...
        migrations.AddField(
            model_name='packages',
            name='default_slide',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='default_slide', to='civic_sandbox.Slide'),
        ),
        migrations.AddField(
            model_name='packages',
            name='foundations',
